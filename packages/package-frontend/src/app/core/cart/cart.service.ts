...
export class CartService {
  ...
  removeLineItem(lineItemId: string) {
    ...
    this.http
      .delete<Cart>(
        `${this.apiUrl}/carts/${cart.id}/${cart.version}/lineItems/${lineItemId}`
      )
      .subscribe(result => this.cart.next(result));
  }
  ...
  setShippingAddress(address: Address) {
    ...
    return this.http
      .put<Cart>(
        `${this.apiUrl}/carts/${cart.id}/${cart.version}/shippingAddress`,
        {
          ...address
        }
      )
  ...
  setBillingAddress(cart: Cart, address: Address) {
    return this.http
      .put<Cart>(
        `${this.apiUrl}/carts/${cart.id}/${cart.version}/billingAddress`,
        {
          ...address
        }
      )
  ...
  setShippingMethod(cart: Cart, shippingMethodId: string) {
    return this.http
      .put<Cart>(
        `${this.apiUrl}/carts/${cart.id}/${cart.version}/shippingMethod`,
        {
  ...
  setCartInfo(
    ...
    return this.setShippingAddress(shippingAddress).pipe(
